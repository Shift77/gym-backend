...
def custom_coach_validator(value):
    '''Validating if the coach has is_coach as True.'''
...
class Exercise(models.Model):
    ...
    secondary_target_muscle = models.CharField(max_length=255, blank=True, null=True)
...
class SubPlan(models.Model):
    ...
    plan = models.ForeignKey(Plan, on_delete=models.CASCADE, related_name='sub_plans')
